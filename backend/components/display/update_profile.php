...
if(isset($_POST['submit'])){
    ...
    if(!empty($name)){
       $update_name = $conn->prepare("UPDATE tbl_user SET name = ? WHERE user_id = ?");
    ...
    $select_prev_pass = $conn->prepare("SELECT password FROM tbl_user WHERE user_id = ?");
    ...
    if($old_pass != $empty_pass){
       if($old_pass != $prev_pass){
          ...
          if($new_pass != $empty_pass){
             $update_pass = $conn->prepare("UPDATE tbl_user SET password = ? WHERE user_id = ?");
...
<div class="head-page">
    ...
    <p><a href="profile.php">profile</a><span> / update</span></p>
</div>
